...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EmpleosService", function() { return EmpleosService; });
...
let EmpleosService = class EmpleosService {
    constructor(afs) {
        this.afs = afs;
    }
    getEmpleos() {
    ...
    getEmpleosPorNombre() {
        return this.afs.collection('empleos', ref => ref.where("titulo", "==", "ICC")
            .orderBy('fecha', 'asc')).valueChanges();
    }
    getEmpleo(uid) {
        let itemDoc = this.afs.doc(`empleos/${uid}`);
    ...
    saveEmpleado2(empleo) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            return yield this.afs.firestore
                .runTransaction((transaction) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                const doc = yield transaction.get(refCount);
    ...
    getEmpleoById2(uid) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            try {
                let aux = yield this.afs.collection("empleos", ref => ref.where('uid', '==', uid))
    ...
    getTelefonos(uid) {
        return this.afs.collection('empleos').doc(uid).collection('telefonos', ref => ref.orderBy('numero', 'asc')).valueChanges();
    }
    getEmpleos2() {
        return this.afs.collection('empleos').valueChanges()
...
EmpleosService.ctorParameters = () => [
    { type: _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"] }
];
EmpleosService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
