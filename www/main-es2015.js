...
const routes = [
    {
        path: 'lista-empleos',
        loadChildren: () => Promise.all(/*! import() | lista-empleos-lista-empleos-module */[__webpack_require__.e("common"), __webpack_require__.e("lista-empleos-lista-empleos-module")]).then(__webpack_require__.bind(null, /*! ./lista-empleos/lista-empleos.module */ "./src/app/lista-empleos/lista-empleos.module.ts")).then(m => m.ListaEmpleosPageModule)
    },
    {
        path: '',
    ...
    {
        path: 'hello',
        loadChildren: () => __webpack_require__.e(/*! import() | hello-hello-module */ "hello-hello-module").then(__webpack_require__.bind(null, /*! ./hello/hello.module */ "./src/app/hello/hello.module.ts")).then(m => m.HelloPageModule)
    },
    {
        path: 'hello/:id',
        loadChildren: () => __webpack_require__.e(/*! import() | hello-hello-module */ "hello-hello-module").then(__webpack_require__.bind(null, /*! ./hello/hello.module */ "./src/app/hello/hello.module.ts")).then(m => m.HelloPageModule)
    ...
    {
        path: 'data',
        loadChildren: () => __webpack_require__.e(/*! import() | data-data-module */ "data-data-module").then(__webpack_require__.bind(null, /*! ./data/data.module */ "./src/app/data/data.module.ts")).then(m => m.DataPageModule)
    },
    {
        path: 'estudio',
        loadChildren: () => __webpack_require__.e(/*! import() | estudio-estudio-module */ "estudio-estudio-module").then(__webpack_require__.bind(null, /*! ./estudio/estudio.module */ "./src/app/estudio/estudio.module.ts")).then(m => m.EstudioPageModule)
    },
    {
        path: 'presentacion',
    ...
    {
        path: 'empleo',
        loadChildren: () => Promise.all(/*! import() | empleo-empleo-module */[__webpack_require__.e("common"), __webpack_require__.e("empleo-empleo-module")]).then(__webpack_require__.bind(null, /*! ./empleo/empleo.module */ "./src/app/empleo/empleo.module.ts")).then(m => m.EmpleoPageModule)
    },
    {
        path: 'empleo/:id',
        loadChildren: () => Promise.all(/*! import() | empleo-empleo-module */[__webpack_require__.e("common"), __webpack_require__.e("empleo-empleo-module")]).then(__webpack_require__.bind(null, /*! ./empleo/empleo.module */ "./src/app/empleo/empleo.module.ts")).then(m => m.EmpleoPageModule)
    ...
    {
        path: 'crear-empleo',
        loadChildren: () => Promise.all(/*! import() | crear-empleo-crear-empleo-module */[__webpack_require__.e("common"), __webpack_require__.e("crear-empleo-crear-empleo-module")]).then(__webpack_require__.bind(null, /*! ./crear-empleo/crear-empleo.module */ "./src/app/crear-empleo/crear-empleo.module.ts")).then(m => m.CrearEmpleoPageModule)
    },
    {
        path: 'actualizar-empleo',
        loadChildren: () => Promise.all(/*! import() | actualizar-empleo-actualizar-empleo-module */[__webpack_require__.e("common"), __webpack_require__.e("actualizar-empleo-actualizar-empleo-module")]).then(__webpack_require__.bind(null, /*! ./actualizar-empleo/actualizar-empleo.module */ "./src/app/actualizar-empleo/actualizar-empleo.module.ts")).then(m => m.ActualizarEmpleoPageModule)
    },
    {
...
/* harmony import */ var _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @angular/fire/firestore */ "./node_modules/@angular/fire/fesm2015/angular-fire-firestore.js");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [
            ...
            _angular_fire__WEBPACK_IMPORTED_MODULE_9__["AngularFireModule"].initializeApp(src_environments_environment__WEBPACK_IMPORTED_MODULE_13__["environment"].firebaseConfig),
...
let AuthService = class AuthService {
    constructor(afAuth, afs, platform, googlePlus) {
        this.afAuth = afAuth;
        this.afs = afs;
        this.platform = platform;
    ...
    nativeGoogleLogin() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            try {
                ...
                const googleCredential = firebase_app__WEBPACK_IMPORTED_MODULE_7__["auth"].GoogleAuthProvider.credential(gplusUser.idToken);
                const firebaseUser = yield firebase_app__WEBPACK_IMPORTED_MODULE_7__["auth"]().signInWithCredential(googleCredential);
                return yield this.updateUserData(firebaseUser, "google");
            }
            catch (err) {
    ...
    webGoogleLogin() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            try {
                ...
                return yield this.updateUserData(credential.user, "google");
            }
            catch (err) {
    ...
    emailPasswordLogin(email, password) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            try {
                const emailCredential = firebase_app__WEBPACK_IMPORTED_MODULE_7__["auth"].EmailAuthProvider.credential(email, password);
                const firebaseUser = yield firebase_app__WEBPACK_IMPORTED_MODULE_7__["auth"]().signInWithCredential(emailCredential);
                return yield this.updateUserData(firebaseUser.user, "email");
            }
            catch (err) {
                return err;
            }
    ...
    updateUserData(usertemp, provider) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            console.log("update", JSON.stringify(usertemp));
            const doc = yield this.userExists(usertemp.email);
            let data;
            let user = JSON.parse(JSON.stringify(usertemp));
...
const environment = {
    production: false,
    firebaseConfig: {
        apiKey: "AIzaSyCC2R0gMgIWGMHmloVWwVr8PQSoDQ6T_yI",
        authDomain: "empleos-cd2fb.firebaseapp.com",
        databaseURL: "https://empleos-cd2fb.firebaseio.com",
        projectId: "empleos-cd2fb",
...
module.exports = __webpack_require__(/*! D:\stali\Documents\UPS8\Plataformas Moviles\Practicas\Hoja-de-Vida-Ionic\src\main.ts */"./src/main.ts");
